...
<img src='/images/IC.gif' height="50%" width="50%">
  ...
  * Description: 
    * Things tend to be cascaded through a social network easily. Business man use social network to advertise their newest project. Adversary try to spread rumor through social network. Furthermore, as the development speed of social network increase rapidly, we need to take the evolving character of the ntetwork into consideration. However, most of the recent work depends on statistic network. **This study shows the critical scale of "seed" that we need to percolate the influence to the whole network that is evloving.**
  * Methods: 
